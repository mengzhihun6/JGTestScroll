...
//#import "UINavigationBar+JGAlpha.h" //不常用
...
#import "UIImage+JGGif.h"
#import "UIImage+JGQRCode.h"
#import "UIImage+JGRotate.h"
...
//String
#import "NSString+JGUrl.h" //URL字符串的URLencode与URLdecode
#import "NSString+JGDecimalNumber.h" //处理高进度数字的工具类
#import "NSString+JGCache.h"
#import "NSString+JGFunc.h"
#import "NSMutableAttributedString+JGExtension.h" //富文本处理
